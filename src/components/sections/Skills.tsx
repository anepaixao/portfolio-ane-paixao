    ...
    >
      <div className="section-shell">
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
          {skills.map((group) => (
            <article
              className="flex h-full flex-col rounded-lg border border-white/10 bg-portfolio-card p-6 shadow-xl shadow-black/10 transition hover:-translate-y-1 hover:border-portfolio-lilac/60 hover:shadow-portfolio-blue/10"
              key={group.category}
            >
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                {group.skills.map((skill) => (
                  <span
                    className="rounded-full border border-white/10 bg-white/[0.04] px-3 py-1.5 text-sm font-semibold text-portfolio-muted transition hover:border-portfolio-blue/40 hover:text-portfolio-text"
