        ...
        <div className="mt-12 space-y-6 lg:relative lg:space-y-0">
          ...
          {experiences.map((experience) => (
            ...
            >
              ...
              <div className="rounded-lg border border-white/10 bg-portfolio-card p-6 shadow-xl shadow-black/10 transition hover:-translate-y-1 hover:border-portfolio-lilac/60 sm:p-7">
